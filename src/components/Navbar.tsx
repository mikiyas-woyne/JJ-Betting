    ...
    <header className="sticky top-0 z-40 bg-slate-900 border-b border-slate-800 text-white shadow-md">
      ...
      <div className="bg-slate-950 px-4 py-1 text-xs text-slate-400 flex items-center justify-between border-b border-slate-800/80">
        <div className="flex items-center gap-2">
          ...
          <span className="font-medium text-slate-300">National Gaming License #LMB-89241</span>
          <span className="hidden sm:inline text-slate-500">• 18+ Play Responsibly</span>
        </div>
        <div className="flex items-center gap-3">
          ...
          >
            ...
            <span className="hidden sm:inline">Responsible Play</span>
          </button>
          <div className="text-slate-500">|</div>
          <div className="text-emerald-400 font-mono font-semibold">ETB</div>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-4">
          ...
          >
            <div className="w-9 h-9 rounded-lg bg-emerald-500 flex items-center justify-center font-black text-slate-950 text-xl tracking-tight shadow-lg shadow-emerald-500/20">
              A
            </div>
            <div>
              <div className="font-black text-lg sm:text-xl tracking-wide leading-none text-white">
                APEX <span className="text-emerald-400">SPORTS</span>
              </div>
          ...
          {/* Desktop View Switcher (Sportsbook vs Admin Desk) */}
        ...
        <div className="flex items-center gap-2 sm:gap-3">
          ...
          <button
            ...
            className="relative p-2 rounded-lg bg-slate-800/80 hover:bg-slate-700 text-slate-300 border border-slate-700/70 transition-colors cursor-pointer"
            title="Notifications"
          >
          ...
          {/* User Account / KYC Verified Avatar */}
          <div className="hidden lg:flex items-center gap-2 pl-2 border-l border-slate-800 text-xs">
            ...
            <div className="leading-tight">
              ...
              <div className="flex items-center gap-1 text-[10px] text-emerald-400">
                <ShieldCheck className="w-3 h-3" /> Tier 1 KYC
              </div>
            </div>
          </div>
        </div>
